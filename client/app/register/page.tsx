...
export default function RegisterPage() {
  ...
  const handleSubmit = async (values: RegisterForm) => {
    ...
    try {
      ...
      const response = await fetch(`${selectedBackend.baseUrl}/api/auth/register`, {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <Center mih="100dvh">
      <Card withBorder className="w-full max-w-[400px]">
        <Text size="xl" fw={700} mb="md">Register</Text>
        ...
        <Group justify="center">
          <Text size="sm" c="dimmed">
            ...
            <Button variant="subtle" size="sm" onClick={() => router.push('/login')}>
              Login
            </Button>
          </Text>
        </Group>
